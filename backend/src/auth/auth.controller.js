...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.test = function (req) {
    ...
    (function () {
        ...
        _signUp_decorators = [(0, common_1.Post)('signup'), (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true }))];
        _signIn_decorators = [(0, common_1.Post)('login'), (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true }))];
        _test_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Get)('test')];
