...
exports.ProfessionnelController = void 0;
var common_1 = require("@nestjs/common");
var jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
var ProfessionnelController = function () {
    var _classDecorators = [(0, common_1.Controller)('professionnel'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var ProfessionnelController = _classThis = /** @class */ (function () {
        function ProfessionnelController_1(svc) {
            this.svc = (__runInitializers(this, _instanceExtraInitializers), svc);
        }
        ProfessionnelController_1.prototype.getProfile = function (req) {
            return this.svc.findOne(req.user.uuid);
        };
        ProfessionnelController_1.prototype.updateProfile = function (req, body) {
            return this.svc.upsert(__assign({ uuid: req.user.uuid }, body));
        };
        return ProfessionnelController_1;
    }());
    __setFunctionName(_classThis, "ProfessionnelController");
    (function () {
        ...
        ProfessionnelController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProfessionnelController = _classThis;
}();
exports.ProfessionnelController = ProfessionnelController;
