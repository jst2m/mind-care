...
var PatientController = function () {
    var _classDecorators = [(0, common_1.Controller)('patient'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var PatientController = _classThis = /** @class */ (function () {
        function PatientController_1(svc) {
        ...
        PatientController_1.prototype.updateProfile = function (req, body) {
